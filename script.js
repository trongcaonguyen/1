...
function spin() {
  ...
  if (MagicRoaster.includes(Hasil[0])) SelectedItem = "Bánh trung thu";
  if (Sepeda.includes(Hasil[0])) SelectedItem = "Trà sữa Hazelnut";
  if (RiceCooker.includes(Hasil[0])) SelectedItem = "Viên kem Gelato";
  if (LunchBox.includes(Hasil[0])) SelectedItem = "Bánh Donut";
  if (Sanken.includes(Hasil[0])) SelectedItem = "Bánh kem";
  if (Electrolux.includes(Hasil[0])) SelectedItem = "Mì ý bò bằm";
  if (JblSpeaker.includes(Hasil[0])) SelectedItem = "Trà sữa Hạnh nhân";
